...
-- Proposition 1: Find names of Employee whose territory is in France (7) in AdventureWorksDW2019
...
SELECT C.CustomerId, C.CustomerContactName, O.OrderId
...
USE Northwinds2020TSQLV6
SELECT O.orderId, O.CustomerId, S.ShipperCompanyName, O.OrderDate, O.ShipToCountry
FROM Sales.[Order] AS O
FULL OUTER JOIN Sales.[Shipper] AS S
ON O.ShipperId = S.ShipperId
WHERE S.ShipperCompanyName = 'Shipper ZHISN' AND O.ShipToCountry = 'Germany';
